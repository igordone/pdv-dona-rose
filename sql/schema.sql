...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS payment_status VARCHAR(30) DEFAULT 'pendente';
...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS payment_copia_e_cola TEXT;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS payment_external_reference VARCHAR(100);
